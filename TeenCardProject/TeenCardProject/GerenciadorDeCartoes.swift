...
class GerenciadorDeCartoes
{
    ...
    static func getCartoesDoCliente() -> [CartaoPrePago]
    {
        ...
        meusCartoes.append(CartaoPrePago(proxy: "3713100018790", numeroDoCartao: "4213040011977072", nomeCompleto: "Vitor Schiavo", tipo: .TeenCardDependente, validade: "03/20"))
        ...
        meusCartoes.append(CartaoPrePago(proxy: "3713100018816", numeroDoCartao: "4213040011952828", nomeCompleto: "lucas Silva", tipo: .TeenCardTitular, validade: "03/20"))
        meusCartoes.append(CartaoPrePago(proxy: "3713100018824", numeroDoCartao: "4213040011964575", nomeCompleto: "filipe silva", tipo: .TeenCardDependente, validade: "03/20"))
