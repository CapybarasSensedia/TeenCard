//
//  CartoesPaiTableViewController.swift
//  TeenCardProject
//
...
class CartoesPaiTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let nib = UINib(nibName: "CartaoPaiCell", bundle: nil)
        tableView.register(nib, forCellReuseIdentifier: "CartaoPaiCell")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "CartaoPaiCell", for: indexPath) as! CartaoPaiTableViewCell
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "CartaoPaiSegue", sender: nil)
    }
